...
// Akan dipanggil jika request codenya ADD
                            if (result.getResultCode() ==
                                ...
                                Note note =
                                        result.getData().getParcelableExtra(NoteAddUpdateActivity.EXTRA_NOTE);
                                ...
                                Note note =
                                        result.getData().getParcelableExtra(NoteAddUpdateActivity.EXTRA_NOTE);
                                int position =
                                        result.getData().getIntExtra(NoteAddUpdateActivity.EXTRA_POSITION, 0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new NoteAdapter(new
                                          NoteAdapter.OnItemClickCallback() {
                                              @Override
                                              public void onItemClicked(Note selectedNote,
                                                                        Integer position) {
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelableArrayList(EXTRA_STATE,
    ...
    private static class LoadNotesAsync {
        ...
        private LoadNotesAsync(Context context, LoadNotesCallback
                callback) {
        ...
        void execute() {
            ...
            executor.execute(() -> {
                ...
                ArrayList<Note> notes =
                        MappingHelper.mapCursorToArrayList(dataCursor);
                noteHelper.close();
